  ...
  return (
    <div className="site-shell">
      ...
      {active === "overview" && <main>
        ...
        <section className="stats-band"><Stat value="4,475" label="approved products" detail="underlying source statement" /><Stat value="10.8%" label="mapped to MoA" detail="482 rows mapped from the supplied FRAC reference" /><Stat value="45" label="MoA groups" detail="IRAC · FRAC · HRAC" /><Stat value="01" label="decision rule" detail="never repeat a group" /></section>
