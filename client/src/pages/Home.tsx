  ...
  return (
    <div className="site-shell">
      ...
      {active === "overview" && <main>
        ...
        <section className="stats-band"><Stat value="4,475" label="approved products" detail="underlying source statement" /><Stat value="55.0%" label="mapped to MoA" detail="2,459 rows mapped from supplied IRAC + FRAC references" /><Stat value="45" label="MoA groups" detail="IRAC · FRAC · HRAC" /><Stat value="01" label="decision rule" detail="never repeat a group" /></section>
